...
public class Example4 {
    public static void main(String[] args) throws JAXBException {
        ...
        FundTransferRequest transferRequest1 = (FundTransferRequest) unmarshaller.unmarshal(
                new File("/Users/localadmin/automation/play-with-xml-json/src/main/resources/transfer-request.xml"));
